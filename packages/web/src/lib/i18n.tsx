  ...
  zh: {
    ...
    hub: {
      ...
      ruleDialog: {
        ...
        roomLabel: "直播间地址 / room", roomSlugSuffix: "(roomSlug: {slug})", roomPlaceholder: "https://live.douyin.com/123456 或房间号",
      ...
      workerDialog: {
        ...
        testOk: "连接成功 · 可见 {count} 场录制", testFailed: "连接失败:{error}", unknownError: "未知错误",
  ...
  en: {
    ...
    hub: {
      ...
      ruleDialog: {
        ...
        roomLabel: "Room URL / id", roomSlugSuffix: " (roomSlug: {slug})", roomPlaceholder: "https://live.douyin.com/123456 or room id",
      ...
      workerDialog: {
        ...
        testOk: "Connected · {count} recordings visible", testFailed: "Connection failed: {error}", unknownError: "Unknown error",
