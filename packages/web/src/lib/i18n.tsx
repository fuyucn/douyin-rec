...
const DICT = {
  zh: {
    ...
    dialog: {
      ...
      schedulePlaceholder: "可选，如 22:30-01:00（支持跨夜）", schedHint: "按本机本地时间判断（现在 {now}{tz}），支持跨夜窗口如 22:30-01:00。",
    ...
    settings: {
      title: "设置", tabAccount: "账号", tabWebhook: "Webhook", tabEngine: "引擎", tabNotif: "通知", tabAbout: "关于",
  ...
  en: {
    ...
    dialog: {
      ...
      schedulePlaceholder: "optional, e.g. 22:30-01:00 (overnight ok)", schedHint: "Judged by local time (now {now}{tz}); overnight windows like 22:30-01:00 supported.",
    ...
    settings: {
      title: "Settings", tabAccount: "Account", tabWebhook: "Webhook", tabEngine: "Engine", tabNotif: "Notifications", tabAbout: "About",
